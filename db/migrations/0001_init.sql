...
-- PostgreSQL + pgvector + FTS. Apply on clean DB.
...
CREATE INDEX idx_auth_tokens_app_id ON auth_tokens(app_id);
...
CREATE INDEX idx_request_metrics_endpoint ON request_metrics(endpoint);
